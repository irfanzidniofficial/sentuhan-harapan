    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.fundraising.update', $fundraising) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4">
                        <x-input-label for="target_amount" :value="_('target_amount')" />
                        <x-text-input id="target_amount" class="block mt-1 w-full" type="number" name="target_amount" value="{{ $fundraising->target_amount }}" required autofocus autocomplete="target_amount" />
                    ...
                    <div class="mt-4">
                        <x-input-label for="about" :value="_('about')" />
