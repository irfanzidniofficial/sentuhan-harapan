            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
               ...
               @endif
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        <a href="{{ route('admin.fundraising.edit', $fundraising) }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            Edit
                        </a>
                        <form action="{{ route('admin.fundraising.destroy', $fundraising) }}" method="POST">
                            @csrf
                            @method('DELETE')
